                            ...
                            <table class="table table-striped jambo_table bulk_action">
                                <thead>
                                    <tr class="headings">
                                        ...
                                        <th class="column-title">用户账号</th>
                                        <th class="column-title">用户名称</th>
                                        <th class="column-title">用户分组</th>
                                ...
                                <tbody>
                                    @foreach($data as $datum)
                                        <tr class="even pointer">
                                            <td class=" ">{{ $datum['id'] }}</td>
                                            <td class=" ">{{ $datum['account'] }}</td>
                                            <td class=" ">{{ $datum['name'] }}</td>
                                            <td class=" ">{{ $datum['role'] }}</td>
                                            <td class=" ">{{ \App\Model\User\UserModel::TYPE_COLLECTION[$datum['type']] }}</td>
                                            <td class=" ">
                                                <a class="btn btn-primary" href="{{ \App\Component\url('admin/auth/user/edit?id=' . $datum['id']) }}"> <i class="fa fa-edit"></i> Edit </a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
